...
```
git clone https://github.com/damalis/full-stack-proxy-nginx-laminas-for-everyone-with-docker-compose.git
```

Open a terminal and `cd` to the folder in which `docker-compose.yml` is saved and run:

```
cd full-stack-proxy-nginx-laminas-for-everyone-with-docker-compose
chmod +x install.sh
./install.sh
```
...
##### # backup exclude laminas, backups folders in ${DIRECTORY_PATH}
